...
QString people_cell::get_person_name(){
    return ui->person_name->text();
}

int people_cell::get_person_type(){
    return ui->person_type->currentIndex();
}

void people_cell::on_delete_person_button_clicked()
{
    QMessageBox::StandardButton reply;
    reply = QMessageBox::question(this, "Delete Confirmation", "Delete this person ?",QMessageBox::Yes|QMessageBox::No);
